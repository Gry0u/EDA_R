...
##Univariate analysis
In adition to the quality variable, thinking about taste and possible flavours of wine, there are 4 more variables that immediately come to mind and that I want to focus on:
...
```
***Observations***  
The distribution is slightly positively skewed, with lot of observations having 0 g/dm3 of citric acid. I would say that this is normal given the [data set description](https://s3.amazonaws.com/udacity-hosted-downloads/ud651/wineQualityInfo.txt) says that citric acid is "found in small quantities".  
